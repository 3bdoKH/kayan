...
const ProjectDetail = () => {
    ...
    const projects = useMemo(() => [
        ...
        },
        {
            ...
            detailedDescription: `تصميم وتنفيذ ديكور داخلي لشقة سكنية بتصميم عصري وألوان متناسقة. تم تنفيذ المشروع على مساحة 180 متر مربع في المقطم. استغرق المشروع 3 أشهر للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `تجديد شقة سكنية قديمة وتحويلها إلى تصميم عصري بتكلفة اقتصادية. تم تنفيذ المشروع على مساحة 120 متر مربع في حدائق الاهرام. استغرق المشروع شهرين للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `تشطيب شقة بتصميم عصري وبتكلفة اقتصادية مناسبة للميزانيات المحدودة. تم تنفيذ المشروع على مساحة 100 متر مربع في اسكندريه. استغرق المشروع شهرين للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `تشطيب فيلا على البحر بتفاصيل فاخرة تراعي الإضاءة الطبيعية والإطلالة البحرية. تم تنفيذ المشروع على مساحة 420 متر مربع في اسكندريه. استغرق المشروع 7 أشهر للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `مساحات عمل عصرية مرنة مع غرف اجتماعات تفاعلية تلائم الشركات الناشئة. تم تنفيذ المشروع على مساحة 280 متر مربع في جسر السويس. استغرق المشروع 4 أشهر للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `إعادة تصميم مركز تجاري مع مناطق عرض مرنة ومسارات حركة واضحة للزوار. تم تنفيذ المشروع على مساحة 520 متر مربع في حدائق الاهرام. استغرق المشروع 5 أشهر للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `مزج الطابع الكلاسيكي مع تفاصيل عصرية للحفاظ على روح الشقة التاريخية. تم تنفيذ المشروع على مساحة 210 متر مربع في القطاميه. استغرق المشروع 3 أشهر للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `تنسيق داخلي وخارجي لفيلا مع حدائق مدمجة ومساحات معيشة مفتوحة. تم تنفيذ المشروع على مساحة 320 متر مربع في المندره. استغرق المشروع 5 أشهر للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `تشطيب شقق فندقية بأثاث مخصص وحلول تخزين ذكية لضمان راحة النزلاء. تم تنفيذ المشروع على مساحة 260 متر مربع في التجمع الخامس. استغرق المشروع 4 أشهر للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `تصميم مجمع طبي متكامل يحقق أعلى معايير التعقيم وراحة المرضى. تم تنفيذ المشروع على مساحة 360 متر مربع في المعادي. استغرق المشروع 5 أشهر للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `تشطيب شقة مدمج بأنظمة المنزل الذكي والتحكم في الإضاءة والصوت. تم تنفيذ المشروع على مساحة 190 متر مربع في المقطم. استغرق المشروع 3 أشهر للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `تهيئة مركز تدريب بتجهيزات متخصصة وقاعات متعددة الاستخدام. تم تنفيذ المشروع على مساحة 280 متر مربع في جسر السويس. استغرق المشروع 4 أشهر للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `تشطيب شقة عملية للشباب تعتمد على حلول التخزين الذكية والأثاث المتعدد الاستخدام. تم تنفيذ المشروع على مساحة 110 متر مربع في اسكندريه. استغرق المشروع شهرين للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `تشطيب شقة فندقية تلائم الرحلات القصيرة مع عزل صوتي كامل. تم تنفيذ المشروع على مساحة 95 متر مربع في المنتزه. استغرق المشروع شهرين للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `تصميم فيلا في منطقة جبلية مع مراعاة العزل الحراري والخامات المقاومة للطقس. تم تنفيذ المشروع على مساحة 340 متر مربع في المقطم. استغرق المشروع 6 أشهر للتنفيذ الكامل.
        ...
        },
        {
            ...
            detailedDescription: `تهيئة مساحات عمل مشتركة مرنة مع مناطق استراحة حديثة ومرافق اجتماعات. تم تنفيذ المشروع على مساحة 295 متر مربع في التجمع الخامس. استغرق المشروع 4 أشهر للتنفيذ الكامل.
